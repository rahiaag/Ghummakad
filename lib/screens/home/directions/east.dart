...
class East extends StatefulWidget {
  const East({super.key});

  @override
  State<East> createState() => _EastState();
}

class _EastState extends State<East> {
  List<String> regionTitles = [];
  List<String> regionImages = [];

  Future getEastIndia() async {
    final url =
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => CategoryLocationDetailsScreen(
                      ...
                      title: regionTitles[index], categoryLocationData: [], categoryIndex: 0,
                    ),
                  ),
                );
              },
